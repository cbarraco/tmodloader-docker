...
```bash
docker run -v <absolute-path-to-folder-with-worlds>:/worlds -p 7777:7777 cbarraco/tmodloader
```
...
```bash
docker run -v <absolute-path-to-folder-to-put-worlds-in>:/worlds cbarraco/tmodloader ""
```
